...
public class SubmitBookForPublishingActivity {
    ...
    public SubmitBookForPublishingResponse execute(SubmitBookForPublishingRequest request) {
        ...
        BookPublishRequest convertedRequest = BookPublishRequestConverter.toBookPublishRequest(request);

        BookPublishRequestManager bookPublishRequestManager = new BookPublishRequestManager();
        bookPublishRequestManager.addBookPublishRequest(convertedRequest);
